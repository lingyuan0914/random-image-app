...
一款支持自定义API源的随机图片浏览应用，主打二次元内容，支持瀑布流浏览、收藏管理等功能。
...
1.从[释放](https://github.com/lingyuan0914/random-image-app/releases)下载最新APK
2.安装到安卓设备（需要Android8.0+)
3.打开应用，添加API源开始浏览
